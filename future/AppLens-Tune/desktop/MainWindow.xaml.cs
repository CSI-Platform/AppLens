using AuditService = AppLens.Backend.TuneAuditService;
using ReportWriter = AppLens.Backend.TuneReportWriter;
...
public sealed partial class MainWindow : Window
{
    ...
    private void SetBusy(bool isBusy)
    {
        ...
        DownloadReportButton.IsEnabled = !isBusy && _snapshot is not null;
